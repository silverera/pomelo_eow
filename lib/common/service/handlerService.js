...
Service.prototype.handle = function(routeRecord, msg, session, cb) {
  ...
  handler[routeRecord.method](msg, session, function(err, resp, opts) {
    if (forwardLogger.isLevelEnabled('DEBUG') && msg.__route__!='replicator.replicationHandler.hearBeat' && msg.__route__!='replicator.replicationHandler.uploadCharState'){
      var log = {
        route : msg.__route__,
        args : msg,
      ...
      forwardLogger.debug(JSON.stringify(log));
    }
